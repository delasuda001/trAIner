    ...
    await expect(
      client.analyze({
        ...
        thresholdEstimate: {
          ...
          retainedPoints: [{ durationS: 600, activityId: "i-1", activityDate: "2025-01-01T00:00:00.000Z" }],
          ...
          biasHint: null,
          staleWarning: { isStale: false, lastValidDaysAgo: null, stalePointCount: 0, oldestRetainedPointWeeks: 2, message: null },
          rejectedPoints: [],
        },
        segmentZones: [],
